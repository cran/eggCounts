...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'zipaired', line 9, column 2 to column 22)",
                                                      " (in 'zipaired', line 10, column 2 to column 19)",
                                                      " (in 'zipaired', line 11, column 2 to column 30)",
                                                      " (in 'zipaired', line 12, column 2 to column 23)",
                                                      " (in 'zipaired', line 13, column 2 to column 28)",
                                                      " (in 'zipaired', line 16, column 2 to column 18)",
                                                      " (in 'zipaired', line 17, column 2 to column 18)",
                                                      " (in 'zipaired', line 19, column 4 to column 32)",
                                                      " (in 'zipaired', line 20, column 4 to column 39)",
                                                      " (in 'zipaired', line 18, column 16 to line 21, column 3)",
                                                      " (in 'zipaired', line 18, column 2 to line 21, column 3)",
                                                      " (in 'zipaired', line 24, column 2 to column 22)",
                                                      " (in 'zipaired', line 25, column 2 to column 23)",
                                                      " (in 'zipaired', line 26, column 2 to column 20)",
                                                      " (in 'zipaired', line 27, column 2 to column 18)",
                                                      " (in 'zipaired', line 28, column 2 to column 31)",
                                                      " (in 'zipaired', line 33, column 6 to column 82)",
                                                      " (in 'zipaired', line 31, column 6 to column 119)",
                                                      " (in 'zipaired', line 30, column 4 to line 33, column 82)",
                                                      " (in 'zipaired', line 29, column 17 to line 34, column 3)",
                                                      " (in 'zipaired', line 29, column 3 to line 34, column 3)",
                                                      " (in 'zipaired', line 39, column 6 to column 82)",
                                                      " (in 'zipaired', line 37, column 6 to column 118)",
                                                      " (in 'zipaired', line 36, column 4 to line 39, column 82)",
                                                      " (in 'zipaired', line 35, column 16 to line 40, column 3)",
                                                      " (in 'zipaired', line 35, column 2 to line 40, column 3)",
                                                      " (in 'zipaired', line 2, column 2 to column 8)",
                                                      " (in 'zipaired', line 3, column 16 to column 17)",
                                                      " (in 'zipaired', line 3, column 2 to column 19)",
                                                      " (in 'zipaired', line 4, column 16 to column 17)",
                                                      " (in 'zipaired', line 4, column 2 to column 19)",
                                                      " (in 'zipaired', line 5, column 12 to column 13)",
                                                      " (in 'zipaired', line 5, column 2 to column 15)",
                                                      " (in 'zipaired', line 6, column 13 to column 14)",
                                                      " (in 'zipaired', line 6, column 2 to column 16)",
                                                      " (in 'zipaired', line 12, column 20 to column 21)",
                                                      " (in 'zipaired', line 16, column 15 to column 16)",
                                                      " (in 'zipaired', line 17, column 15 to column 16)"};
#include <stan_meta_header.hpp>
class model_zipaired final : public model_base_crtp<model_zipaired> {
private:
  int J;
...
public:
  ...
  inline std::string model_name() const final { return "model_zipaired"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_zipaired_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"kappa\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mub\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lambdaa\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"lambdab\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_zipaired_namespace::model_zipaired;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_zipaired_namespace::profiles__;
}
#endif
#endif
