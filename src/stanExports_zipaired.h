...
static constexpr std::array<const char*, 39> locations_array__ =
  ...
  " (in 'string', line 19, column 4 to column 32)",
  " (in 'string', line 20, column 4 to column 39)",
  " (in 'string', line 18, column 16 to line 21, column 3)",
  ...
  " (in 'string', line 33, column 6 to column 82)",
  " (in 'string', line 31, column 6 to column 119)",
  " (in 'string', line 30, column 4 to line 33, column 82)",
  " (in 'string', line 29, column 17 to line 34, column 3)",
  " (in 'string', line 29, column 3 to line 34, column 3)",
  " (in 'string', line 39, column 6 to column 82)",
  " (in 'string', line 37, column 6 to column 118)",
  " (in 'string', line 36, column 4 to line 39, column 82)",
  " (in 'string', line 35, column 16 to line 40, column 3)",
...
public:
  ~model_zipaired() {}
  model_zipaired(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_zipaired_namespace::model_zipaired";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_zipaired_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      }
      {
        ...
        for (int n = 1; n <= J; ++n) {
          ...
          if (stan::math::logical_eq(
                stan::model::rvalue(ystarbraw, "ystarbraw",
                  stan::model::index_uni(n)), 0)) {
            current_statement__ = 18;
            lp_accum__.add(stan::math::log_sum_exp(
                             stan::math::bernoulli_lpmf<false>(1, phi),
                             (stan::math::bernoulli_lpmf<false>(0, phi) +
                             stan::math::poisson_lpmf<false>(
                               stan::model::rvalue(ystarbraw, "ystarbraw",
                                 stan::model::index_uni(n)),
                               stan::model::rvalue(lambdab, "lambdab",
                                 stan::model::index_uni(n))))));
          } else {
            current_statement__ = 17;
            lp_accum__.add((stan::math::bernoulli_lpmf<false>(0, phi) +
              stan::math::poisson_lpmf<false>(
                stan::model::rvalue(ystarbraw, "ystarbraw",
                  stan::model::index_uni(n)),
                stan::model::rvalue(lambdab, "lambdab",
        ...
        for (int n = 1; n <= J; ++n) {
          ...
          if (stan::math::logical_eq(
                stan::model::rvalue(ystararaw, "ystararaw",
                  stan::model::index_uni(n)), 0)) {
            ...
            lp_accum__.add(stan::math::log_sum_exp(
                             ...
                             stan::math::poisson_lpmf<false>(
                               stan::model::rvalue(ystararaw, "ystararaw",
                                 stan::model::index_uni(n)),
                               stan::model::rvalue(lambdaa, "lambdaa",
                                 stan::model::index_uni(n))))));
          } else {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_zipaired_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"kappa", "mu", "delta", "mub", "phi"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"kappa\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mub\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lambdaa\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"lambdab\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((1 + 1) + 1) + J) + 1);
