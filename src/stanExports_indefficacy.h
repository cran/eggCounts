...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'indefficacy', line 9, column 2 to column 22)",
                                                      " (in 'indefficacy', line 10, column 2 to column 19)",
                                                      " (in 'indefficacy', line 11, column 2 to column 25)",
                                                      " (in 'indefficacy', line 12, column 2 to column 28)",
                                                      " (in 'indefficacy', line 13, column 2 to column 34)",
                                                      " (in 'indefficacy', line 14, column 2 to column 23)",
                                                      " (in 'indefficacy', line 17, column 2 to column 18)",
                                                      " (in 'indefficacy', line 18, column 2 to column 18)",
                                                      " (in 'indefficacy', line 20, column 4 to column 32)",
                                                      " (in 'indefficacy', line 21, column 4 to column 42)",
                                                      " (in 'indefficacy', line 19, column 16 to line 22, column 3)",
                                                      " (in 'indefficacy', line 19, column 2 to line 22, column 3)",
                                                      " (in 'indefficacy', line 25, column 2 to column 22)",
                                                      " (in 'indefficacy', line 26, column 2 to column 23)",
                                                      " (in 'indefficacy', line 27, column 2 to column 51)",
                                                      " (in 'indefficacy', line 28, column 2 to column 29)",
                                                      " (in 'indefficacy', line 29, column 2 to column 23)",
                                                      " (in 'indefficacy', line 30, column 2 to column 31)",
                                                      " (in 'indefficacy', line 31, column 2 to column 31)",
                                                      " (in 'indefficacy', line 32, column 2 to column 31)",
                                                      " (in 'indefficacy', line 2, column 2 to column 8)",
                                                      " (in 'indefficacy', line 3, column 16 to column 17)",
                                                      " (in 'indefficacy', line 3, column 2 to column 19)",
                                                      " (in 'indefficacy', line 4, column 16 to column 17)",
                                                      " (in 'indefficacy', line 4, column 2 to column 19)",
                                                      " (in 'indefficacy', line 5, column 12 to column 13)",
                                                      " (in 'indefficacy', line 5, column 2 to column 15)",
                                                      " (in 'indefficacy', line 6, column 13 to column 14)",
                                                      " (in 'indefficacy', line 6, column 2 to column 16)",
                                                      " (in 'indefficacy', line 11, column 22 to column 23)",
                                                      " (in 'indefficacy', line 14, column 20 to column 21)",
                                                      " (in 'indefficacy', line 17, column 15 to column 16)",
                                                      " (in 'indefficacy', line 18, column 15 to column 16)"};
...
public:
  ...
  inline std::string model_name() const final { return "model_indefficacy"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_indefficacy_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      delta = std::vector<local_scalar_t__>(J, DUMMY_VAR__);
      ...
      for (int sym1__ = 1; sym1__ <= J; ++sym1__) {
        ...
        if (jacobian__) {
          current_statement__ = 3;
          assign(delta, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(delta[(sym1__ - 1)], 0, lp__),
            "assigning variable delta");
        } else {
          current_statement__ = 3;
          assign(delta, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(delta[(sym1__ - 1)], 0),
            "assigning variable delta");
        }}
      local_scalar_t__ delta_shape;
      delta_shape = DUMMY_VAR__;
      
      current_statement__ = 4;
      delta_shape = in__.scalar();
      current_statement__ = 4;
      if (jacobian__) {
        current_statement__ = 4;
        delta_shape = stan::math::lb_constrain(delta_shape, 0, lp__);
      } else {
        current_statement__ = 4;
        delta_shape = stan::math::lb_constrain(delta_shape, 0);
      }
      local_scalar_t__ delta_mu;
      delta_mu = DUMMY_VAR__;
      
      current_statement__ = 5;
      delta_mu = in__.scalar();
      current_statement__ = 5;
      if (jacobian__) {
        current_statement__ = 5;
        delta_mu = stan::math::lub_constrain(delta_mu, 0, 1, lp__);
      } else {
        current_statement__ = 5;
        delta_mu = stan::math::lub_constrain(delta_mu, 0, 1);
      }
      std::vector<local_scalar_t__> mub;
      mub = std::vector<local_scalar_t__>(J, DUMMY_VAR__);
          ...
          "assigning variable lambdaa");}
      {
        ...
        lp_accum__.add(
          gamma_lpdf<propto__>(delta, delta_shape, (delta_shape / delta_mu)));
        current_statement__ = 16;
        lp_accum__.add(normal_lpdf<propto__>(delta_shape, 2, 1));
        current_statement__ = 17;
        lp_accum__.add(beta_lpdf<propto__>(delta_mu, 1, 1));
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      delta = std::vector<double>(J, std::numeric_limits<double>::quiet_NaN());
      ...
      for (int sym1__ = 1; sym1__ <= J; ++sym1__) {
        ...
        assign(delta, cons_list(index_uni(sym1__), nil_index_list()),
          ...
          "assigning variable delta");}
      double delta_shape;
      delta_shape = std::numeric_limits<double>::quiet_NaN();
      ...
      delta_shape = stan::math::lb_constrain(delta_shape, 0);
      double delta_mu;
      delta_mu = std::numeric_limits<double>::quiet_NaN();
      ...
      mub = std::vector<double>(J, std::numeric_limits<double>::quiet_NaN());
      ...
      vars__.emplace_back(delta_shape);
      vars__.emplace_back(delta_mu);
      for (int sym1__ = 1; sym1__ <= J; ++sym1__) {
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      delta_free__ = std::vector<double>(J, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 3;
      for (int sym1__ = 1; sym1__ <= J; ++sym1__) {
        current_statement__ = 3;
        assign(delta_free__, cons_list(index_uni(sym1__), nil_index_list()),
          stan::math::lb_free(delta[(sym1__ - 1)], 0),
      ...
      double delta_shape_free__;
      delta_shape_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 4;
      delta_shape_free__ = stan::math::lb_free(delta_shape, 0);
      double delta_mu;
      delta_mu = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 5;
      delta_mu = context__.vals_r("delta_mu")[(1 - 1)];
      double delta_mu_free__;
      delta_mu_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 5;
      delta_mu_free__ = stan::math::lub_free(delta_mu, 0, 1);
      std::vector<double> mub;
      mub = std::vector<double>(J, std::numeric_limits<double>::quiet_NaN());
      ...
      mub_free__ = std::vector<double>(J, std::numeric_limits<double>::quiet_NaN());
      ...
      vars__.emplace_back(delta_shape_free__);
      vars__.emplace_back(delta_mu_free__);
      for (int sym1__ = 1; sym1__ <= J; ++sym1__) {
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__.emplace_back("delta_shape");
    names__.emplace_back("delta_mu");
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"kappa\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"delta_shape\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta_mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mub\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"lambdaa\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"lambdab\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"}]";
    return s__.str();
