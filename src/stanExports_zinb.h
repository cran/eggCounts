...
static constexpr std::array<const char*, 25> locations_array__ =
  ...
  " (in 'string', line 27, column 6 to column 80)",
  " (in 'string', line 25, column 6 to column 117)",
  " (in 'string', line 24, column 4 to line 27, column 80)",
  " (in 'string', line 23, column 17 to line 28, column 3)",
  " (in 'string', line 23, column 2 to line 28, column 3)",
  " (in 'string', line 2, column 2 to column 8)",
  " (in 'string', line 3, column 8 to column 9)",
  " (in 'string', line 3, column 2 to column 24)",
...
public:
  ~model_zinb() {}
  model_zinb(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_zinb_namespace::model_zinb";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      stan::math::validate_non_negative_index("ystarraw", "J", J);
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      mui = in__.template read_constrain_lb<std::vector<local_scalar_t__>,
              jacobian__>(0, lp__, J);
      ...
      for (int i = 1; i <= J; ++i) {
        ...
        stan::model::assign(lambda,
          (stan::model::rvalue(mui, "mui", stan::model::index_uni(i)) /
      ...
      }
      {
        ...
        lp_accum__.add(stan::math::gamma_lpdf<propto__>(mui, kappa, (kappa /
                         mu)));
        current_statement__ = 17;
        for (int n = 1; n <= J; ++n) {
          current_statement__ = 15;
          if (stan::math::logical_eq(
                stan::model::rvalue(ystarraw, "ystarraw",
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_zinb_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      std::vector<local_scalar_t__> mui =
        std::vector<local_scalar_t__>(J, DUMMY_VAR__);
      current_statement__ = 3;
      stan::model::assign(mui, in__.read<std::vector<local_scalar_t__>>(J),
        "assigning variable mui");
      out__.write_free_lb(0, mui);
      local_scalar_t__ phi = DUMMY_VAR__;
      current_statement__ = 4;
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      context__.validate_dims("parameter initialization", "mu", "double",
        std::vector<size_t>{});
      current_statement__ = 3;
      context__.validate_dims("parameter initialization", "mui", "double",
        std::vector<size_t>{static_cast<size_t>(J)});
      current_statement__ = 4;
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"kappa", "mu", "mui", "phi"};
    if (emit_transformed_parameters__) {
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    for (int sym1__ = 1; sym1__ <= J; ++sym1__) {
      param_names__.emplace_back(std::string() + "mui" + '.' +
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"kappa\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mui\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lambda\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(J) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((1 + 1) + J) + 1);
