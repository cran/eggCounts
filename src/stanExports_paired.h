...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'paired', line 9, column 2 to column 22)",
                                                      " (in 'paired', line 10, column 2 to column 19)",
                                                      " (in 'paired', line 11, column 2 to column 30)",
                                                      " (in 'paired', line 12, column 2 to column 23)",
                                                      " (in 'paired', line 15, column 2 to column 18)",
                                                      " (in 'paired', line 16, column 2 to column 18)",
                                                      " (in 'paired', line 18, column 4 to column 32)",
                                                      " (in 'paired', line 19, column 4 to column 39)",
                                                      " (in 'paired', line 17, column 16 to line 20, column 3)",
                                                      " (in 'paired', line 17, column 2 to line 20, column 3)",
                                                      " (in 'paired', line 23, column 2 to column 22)",
                                                      " (in 'paired', line 24, column 2 to column 23)",
                                                      " (in 'paired', line 25, column 2 to column 20)",
                                                      " (in 'paired', line 26, column 2 to column 31)",
                                                      " (in 'paired', line 27, column 2 to column 31)",
                                                      " (in 'paired', line 28, column 2 to column 31)",
                                                      " (in 'paired', line 2, column 2 to column 8)",
                                                      " (in 'paired', line 3, column 16 to column 17)",
                                                      " (in 'paired', line 3, column 2 to column 19)",
                                                      " (in 'paired', line 4, column 16 to column 17)",
                                                      " (in 'paired', line 4, column 2 to column 19)",
                                                      " (in 'paired', line 5, column 12 to column 13)",
                                                      " (in 'paired', line 5, column 2 to column 15)",
                                                      " (in 'paired', line 6, column 13 to column 14)",
                                                      " (in 'paired', line 6, column 2 to column 16)",
                                                      " (in 'paired', line 12, column 20 to column 21)",
                                                      " (in 'paired', line 15, column 15 to column 16)",
                                                      " (in 'paired', line 16, column 15 to column 16)"};
#include <stan_meta_header.hpp>
class model_paired final : public model_base_crtp<model_paired> {
private:
  int J;
...
public:
  ...
  inline std::string model_name() const final { return "model_paired"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_paired_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"kappa\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mub\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"lambdaa\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"},{\"name\":\"lambdab\",\"type\":{\"name\":\"array\",\"length\":" << J << ",\"element_type\":{\"name\":\"real\"}},\"block\":\"transformed_parameters\"}]";
    return s__.str();
...
using stan_model = model_paired_namespace::model_paired;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_paired_namespace::profiles__;
}
#endif
#endif
